...
(function (window, document, Laya) {
    ...
    var Animation = laya.display.Animation, Browser = laya.utils.Browser, ClassUtils = laya.utils.ClassUtils,
        ColorFilter = laya.filters.ColorFilter;
    var Component = laya.components.Component, Const = laya.Const, Ease = laya.utils.Ease, Event = laya.events.Event,
        Graphics = laya.display.Graphics;
    var Handler = laya.utils.Handler, Input = laya.display.Input, Loader = laya.net.Loader,
        LocalStorage = laya.net.LocalStorage;
    var Matrix = laya.maths.Matrix, Node = laya.display.Node, Point = laya.maths.Point,
        Rectangle = laya.maths.Rectangle;
    var Render = laya.renders.Render, Scene = laya.display.Scene, SceneUtils = laya.utils.SceneUtils,
    ...
    var DialogManager = (function (_super) {
        function DialogManager() {
            ...
            this.popupEffect = function (dialog) {
                dialog.scale(1, 1);
                dialog._effectTween = Tween.from(dialog, {
                    x: Laya.stage.width / 2,
                    y: Laya.stage.height / 2,
                    scaleX: 0,
                    scaleY: 0
                }, 300, Ease.backOut, Handler.create(this, this.doOpen, [dialog]), 0, false, false);
            }
            /**@private 全局默认关闭对话框效果，可以设置一个效果代替默认的关闭效果，如果不想有任何效果，可以赋值为null*/
            this.closeEffect = function (dialog) {
                dialog._effectTween = Tween.to(dialog, {
                    x: Laya.stage.width / 2,
                    y: Laya.stage.height / 2,
                    scaleX: 0,
                    scaleY: 0
                }, 300, Ease.strongOut, Handler.create(this, this.doClose, [dialog]), 0, false, false);
            }
...
//class laya.ui.Button extends laya.ui.UIComponent
    var Button = (function (_super) {
        ...
        __proto.onMouse = function (e) {
            var darkFilter = new ColorFilter([
                1, 0, 0, 0, -71,
                0, 1, 0, 0, -71,
                0, 0, 1, 0, -71,
                0, 0, 0, 1, 0
            ...
            if (e.type ===/*laya.events.Event.CLICK*/"click") {
                ...
                return;
            } else if (e.type ===/*laya.events.Event.CLICK*/"mousedown") {
                if (this._stateNum == 1) {
                    if (UIConfig.singleButtonStyle == "scale") {
                        this.scaleX__ = this.scaleX;
                        this.scaleY__ = this.scaleY;
                        this.scaleX = this.scaleX__ - 0.1;
                        this.scaleY = this.scaleY__  - 0.1;
                    } else if (UIConfig.singleButtonStyle == "color") {
                        UIUtils.clearFilter(this, ColorFilter);
                        UIUtils.addFilter(this, darkFilter);
                    }
                }
            } else if (e.type ===/*laya.events.Event.CLICK*/"mouseup") {
                if (this._stateNum == 1) {
                    if (UIConfig.singleButtonStyle == "scale") {
                        this.scaleX = this.scaleX__ ;
                        this.scaleY = this.scaleY__ ;
                    } else if (UIConfig.singleButtonStyle == "color") {
                        UIUtils.clearFilter(this, ColorFilter);
                    }
                    if (UIConfig.defaultClickSound != null && UIConfig.defaultClickSound != '') {
                        Laya.SoundManager.playSound(UIConfig.defaultClickSound,1);
                    }
                }
            } else if (e.type ===/*laya.events.Event.CLICK*/"mouseout") {
                if (this._stateNum == 1) {
                    if (UIConfig.singleButtonStyle == "scale") {
                        this.scaleX = this.scaleX__ ;
                        this.scaleY = this.scaleY__ ;
