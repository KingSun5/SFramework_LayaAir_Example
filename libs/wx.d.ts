...
declare namespace wx {
    ...
    function aldShareAppMessage(object: { title?: string, ald_desc?: string, imageUrl?: string, imageUrlId?: string, query?: string }): void;
     ...
     * 监听用户点击右上角菜单的“转发”按钮时触发的事件
     */
    function aldOnShareAppMessage(callback: (res: {
        title: string,
        imageUrl: string,
        imageUrlId: string,
        query: string
     ...
     *  }
     */
    function aldSendEvent(eventName: string, args?: any);
}
